...
def create_final_topology():
    ...
    # ====================================================================
    # === AGGIUNTA E COLLEGAMENTO DEL NODO NAT DI MININET ALLA FINE =====
    # ====================================================================
    ...
    # Colleghiamo r2 (usando una porta libera, la 4) a nat0.
