...
def create_complex_topology():
    ...
    # ... (Aggiunta di switch e host rimane identica) ...
    ...
    # ... (Tutti gli altri link rimangono identici) ...
    ...
    # ====================================================================
    # === AGGIUNTA DEL NODO NAT (CON IL NUOVO IP) ========================
    # ====================================================================
    info('*** Aggiunta del nodo NAT per la connessione esterna\n')
    # Usiamo la nuova rete 172.16.0.0/24
    nat0 = net.addNAT(name='nat0', ip='172.16.0.254/24', inNamespace=False)
    # Collega R2 (porta 3) al NAT
    net.addLink(r2, nat0, port1=3)
    # ====================================================================
